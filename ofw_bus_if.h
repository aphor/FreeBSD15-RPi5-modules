...
static __inline const struct ofw_bus_devinfo *
OFW_BUS_GET_DEVINFO(device_t bus,
                                                                   device_t dev)
{
	kobjop_t _m;
...
OFW_BUS_GET_COMPAT(device_t bus, device_t dev)
{
	kobjop_t _m;
	const char * rc;
...
static __inline const char *
OFW_BUS_GET_MODEL(device_t bus, device_t dev)
{
	kobjop_t _m;
	const char * rc;
...
static __inline const char *
OFW_BUS_GET_NAME(device_t bus, device_t dev)
{
	kobjop_t _m;
	const char * rc;
...
OFW_BUS_GET_NODE(device_t bus, device_t dev)
{
	kobjop_t _m;
	phandle_t rc;
...
static __inline const char *
OFW_BUS_GET_TYPE(device_t bus, device_t dev)
{
	kobjop_t _m;
	const char * rc;
...
static __inline int
OFW_BUS_MAP_INTR(device_t bus, device_t dev,
